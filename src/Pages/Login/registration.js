                    ...
                    <form className="flex flex-col pt-3 md:pt-8">
                        <div className="relative h-10 input-component empty ml-12 mb-8">
                            <input
                                ...
                                type="text"
                                name="firstname"
                                className="h-14 w-11/12 rounded-full px-3 py-4 transition-all border-gray-500"
                            />
                        ...
                        <input type="submit" value="Register" className="ml-16 bg-blue-400 text-white font-bold text-lg hover:bg-blue-300 p-3 mt-9  max-w-lg rounded-full"/>
                    </form>
                    <Link to="/">
                    <div className="text-center pl-16 pt-12 pb-12">
